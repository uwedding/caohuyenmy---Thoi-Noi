...
const GOOGLE_SCRIPT_URL_THAM_DU =
  "https://script.google.com/macros/s/AKfycbyi-OrvBcg_MM7odQDFzCn5yKqXHaj8tjdCJJa0f5aNsBKgYnt3r0xlVMdf_QShaK7M/exec";

const closeIds = ["w-4e9p787b"];
const formIds = ["tdidxoc8"];

formIds.forEach(function (id, index) {
  const form = document.getElementById(id);
  const closeBtn = document.getElementById(closeIds[index]);
  console.log("🚀 Form:", form, "CloseBtn:", closeBtn);
...
const sheetID = "1W9GVp8u8p_y63mMJqSLDv-1XzCdB60ONgGNFINWzGRw";
